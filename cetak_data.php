                ...
                <table class="print-table" id="table-guru">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="font-family: monospace; font-size:0.7rem;"><?php echo htmlspecialchars($guru['nik'] ?? '-'); ?></td>
                        ...
                        <?php 
                                ...
                                echo '<td colspan="7" style="text-align:right;padding-right:15px;">';
...
function exportToCSV() {
    ...
    // Header tabel
    csvContent += '"No","NIK","Nama","Profesi","Tempat Mengajar","Bank","No. Rekening","No. HP"\n';
