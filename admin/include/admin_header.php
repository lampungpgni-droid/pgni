...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* ADMIN hanya menampilkan menu tertentu - tidak termasuk Berita, Pengurus, Yayasan */
        .role-admin .menu-admin-only {
            display: none !important; /* Sembunyikan semua menu admin-only */
        }
        
        /* Tampilkan menu khusus admin yang diizinkan */
...
<aside class="admin-sidebar" id="adminSidebar">
    ...
    <div class="sidebar-menu-wrapper">
        <ul class="sidebar-menu">
            ...
            <li class="menu-super-admin <?php echo isActive('dashboard.php'); ?>">
                <a href="dashboard.php"><i class="fas fa-home"></i> Dashboard</a>
            </li>
            
            <!-- Dashboard Admin -->
            <li class="role-admin <?php echo isActive('dashboard_admin.php'); ?>">
                <a href="dashboard_admin.php"><i class="fas fa-home"></i> Dashboard</a>
            </li>
            
            <!-- Dashboard Petugas -->
            <li class="menu-petugas-only <?php echo isActive('dashboard_petugas.php'); ?>">
                <a href="dashboard_petugas.php"><i class="fas fa-home"></i> Dashboard</a>
            </li>
            ...
            <li>
				<a href="running_text.php">
					<i class="fas fa-running"></i> Running Text
				</a>
			</li>
            
            <!-- ============================================
                 KONTEN - HANYA SUPER ADMIN
                 (Admin tidak melihat Berita, Pengurus, Yayasan)
            ============================================ -->
            <li class="menu-label menu-super-admin">Konten</li>
            
            <!-- Berita - Hanya Super Admin -->
            ...
            ============================================ -->
            <li class="menu-label menu-super-admin">Sistem</li>
            
            <!-- User Management -->
            <li class="menu-super-admin <?php echo isActive(['user.php', 'user_tambah.php', 'user_edit.php']); ?>">
                <a href="user.php"><i class="fas fa-user-shield"></i> User</a>
            </li>
            
            <!-- Hak Akses -->
            <li class="menu-super-admin <?php echo isActive('permission.php'); ?>">
                <a href="permission.php"><i class="fas fa-key"></i> Hak Akses</a>
            </li>
            
            <!-- Wilayah -->
            <li class="menu-super-admin <?php echo isActive('wilayah.php'); ?>">
                <a href="wilayah.php"><i class="fas fa-map-marker-alt"></i> Wilayah</a>
            </li>
            
            <!-- ============================================
                 LAPORAN - HANYA SUPER ADMIN
                 (Admin tidak melihat Cetak Data)
            ============================================ -->
            <li class="menu-label menu-super-admin">Laporan</li>
            
            <!-- Cetak Data - Hanya Super Admin -->
            <li class="menu-super-admin <?php echo isActive('cetak_data.php'); ?>">
